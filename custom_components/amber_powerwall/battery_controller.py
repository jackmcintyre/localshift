...
class BatteryController:
    ...
    async def set_force_charge(
        ...
        _LOGGER.info("Successfully completed force charge mode transition with validation")
    ...
    async def set_boost_charge(
        ...
        _LOGGER.info("Successfully completed boost charge mode transition with validation")
    ...
    async def set_force_discharge(
        ...
        _LOGGER.info("Successfully completed force discharge mode transition with validation")
