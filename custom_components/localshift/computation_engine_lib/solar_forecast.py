"""Solar forecast utilities.

This module contains methods for solar forecasting calculations derived from
Solcast data. It is split from solar_utils.py to improve maintainability.
"""
...
_LOGGER = logging.getLogger(__name__)  # noqa: N816
