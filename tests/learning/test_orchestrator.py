...
class TestOrchestratorCounterfactual:
    def test_update_medium_tick_updates_counterfactual_metrics(self):
        orchestrator = _make_orchestrator()
        mock_tracker = MagicMock()
        mock_tracker.save_pending = False
        mock_tracker._completed_decisions = []
        ...
        evaluator.evaluate_daily.assert_called_once()
        evaluator.update_performance_metrics.assert_called_once()
