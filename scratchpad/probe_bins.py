...
print(f"{'soc_bins':>9} {'bin width':>10} {'dw_entry':>9} {'shortfall':>10} {'net_cost':>9} {'first_charge':>13} {'solve_s':>8}")
for bins in (50, 100, 200, 400, 900):
    ...
    print(f"{bins:>9} {90.0/(bins-1):>9.2f}pp {r.dw_entry_soc_pct:>9.2f} "
